    ...
    return (
        ...
        >
            {React.Children.toArray(
                items.map((item: { link: string | undefined; image: string | undefined; title: string | undefined; url: string | undefined; name: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined; updated: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined }) => {
                    return (
                        <Box
                            key={item.title}
                            w="350px"
